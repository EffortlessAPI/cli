# 📘 compile-rulebook-test — RuleSpeak®
...
| Who | A defined attribute. | _Who is being greeted._ |
| Introduction | Computed as “Hello ”, followed by the who, followed by “!”. | _The greeting, derived from Name. Never typed by hand._ |
...
| ID | Declarative rule |
|----|------------------|
| **DR-1 Introduction** | A hello who's introduction is computed as “Hello ”, followed by the who, followed by “!”. |
...
|----------------|------|------------|
| **HelloWhos.Introduction** | formula | `"Hello " & Who & "!"` |
