...
{
    public const string Value = "2026.922.33";
    ...
    /// </summary>
    public const string DisplayVersion = "v2026-09-22-0033";

    /// <summary>
    /// The full commit SHA the release was cut from. Stamped by
    /// scripts/release.sh immediately before the release commit.
    /// </summary>
    public const string CommitSha = "2ed4b188598e269eb7bbe62663b0c44ea62c5dcb";
}
