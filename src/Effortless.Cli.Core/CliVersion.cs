...
{
    public const string Value = "2026.911.803";
    ...
    /// </summary>
    public const string DisplayVersion = "v2026-09-11-0803";

    /// <summary>
    /// The full commit SHA the release was cut from. Stamped by
    /// scripts/release.sh immediately before the release commit.
    /// </summary>
    public const string CommitSha = "a1557a14fff0e8b436d187cba0b47d051cf5c63e";
}
